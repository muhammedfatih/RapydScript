...
//        console.log(self);
//            console.log("\n\n\n\n\n\n\n\n\n"+JSON.stringify(self)+"\n\n\n\n\n\n\n\n\n");
//        if(self.expression.property != undefined && typeof self.expression.expression && typeof self.expression.expression.end && typeof self.expression.expression.start && self.expression.expression.end == "[Object]" && self.expression.expression.start == "[Object]"){
//        if(self.expression.property != undefined && typeof self.expression && typeof self.expression.end && typeof self.expression.start && self.expression.end == "[Object]" && self.expression.start == "[Object]"){
//        if(self.expression.property != undefined && typeof self.expression.expression && typeof self.expression.expression.end && typeof self.expression.expression.start && self.expression.expression.end == "[Object]" && self.expression.expression.start == "[Object]"){
        if(true){
            output.print(".__index__(");
...
//console.log(self);
        if(typeof self.right.expression != "undefined"){
            self.left.end.type="class";
            self.left.start.type="class";
//            console.log("<<"+JSON.stringify(self)+">>\n");
//            console.log("<<"+JSON.stringify(self.right.expression.property)+">>\n");
        }
        ...
        }else if (self.left instanceof AST_Sub) {
//            console.log(self.left);
  //          console.log("\n\n\n\n");
            output.print(self.left.start.value);
            if(self.left.expression.property != undefined){
                output.print(".")
                output.print(self.left.expression.property)
            }
            output.print(".__assign__(");
            if(self.left.property.value==undefined){
                output.print(self.left.property.name);
            }else{
                output.print("\"");
                output.print(self.left.property.value);
                output.print("\"");
            }
            output.comma();
            self.right.print(output);
